  ...
  return (
    <div className="bg-white rounded-[30px]   flex flex-col  justify-center col-span-2 p-[35px] ">
      ...
      <p className="mt-[6px] text-grey text-[10px]  text-gray-500">
        I am an incoming Data Engineer Apprentice at Thales looking to develop and use my skillset to transform data into useful and insightful information to optimise business processes and operations. 
      </p>
    </div>
  );
}
