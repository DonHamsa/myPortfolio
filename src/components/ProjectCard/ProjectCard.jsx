...
export default function ProjectCard({
  ...
  return (
    <div className=" group rounded-[30px] grid grid-cols-2 p-[20px] bg-white h-[300px] lg:w-[500px] w-[350px]  gap-7  hover:shadow-xl transition-shadow duration-200 border ">
