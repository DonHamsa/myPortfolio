...
export default function Blogs() {
  return (
    <>
      <div className="lg:pr-[25%] lg:pl-[25%] mb-[20px] pl-[7%] pr-[7%] flex justify-center lg:h-[300px]">
        <BlogPreview
      ...
      <div className="lg:pr-[25%] lg:pl-[25%]  pl-[7%] pr-[7%] flex justify-center mb-[20px] lg:h-[300px]  ">
        <BlogPreview
